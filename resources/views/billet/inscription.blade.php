...
<head>
  <title>Reservation Billets</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta property="og:type" content="siteweb" />
    <meta property="og:url" content="https://vote.misscameroun.org/billet/inscriptions" />
    <meta property="og:image" content="https://vote.misscameroun.org/images/imagebannerbilletcentre.jpg" />
    <meta property="og:title" content="Reservation des billets" />
    <meta property="og:description" content="Reservation des billets" />
...
<body>
  ...
  <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url({{asset('/images/imagebannerbilletcentre.jpg')}});"
    data-aos="fade" data-stellar-background-ratio="0.5" data-aos="fade">
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade-up" data-aos-delay="400">
          <h1 class="text-white">BILLETS POUR LA FINALE NATIONALE</h1>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 col-lg-7 mb-5" style="margin:auto;">
          ...
          <form action="https://vote.misscameroun.org/billet/inscrire-client" class="contact-form" method="post" enctype="multipart/form-data">
            ...
            <div class="row form-group">
             ...
             <div class="row form-group">
              ...
              <div class="row form-group">
              <div class="col-md-12">
                <label class="font-weight-bold" for="Ro">Region du concours</label>
                <select  name="Ro" required class="form-control">
                  
                   <!--<option value="CENTRE">Grand Centre</option>-->
                   <option value="FINALE">FINALE NATIONALE</option>
                   <!--<option value="NORD">Grand Nord</option>-->
          ...
          <div class="row form-group">
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <label class="font-weight-bold" for="type_billet">Choisir le type de billet *</label>
                <select  name="regionconcours" required class="form-control">
                  
                   <option value="5000"> STANDARD - 5000 fcfa</option>
                   <option value="10000">CLASSIC - 10 000 fcfa</option>
                   <option value="25000">VIP - 25 000 fcfa</option>
                   <option value="50000">VVIP - 50 000 fcfa</option>
                   <option value="100000">GOLD - 100 000 fcfa</option>
