    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade-up" data-aos-delay="400">
          <h1 class="text-white">VOTRE INSCRIPTION A REUSSIE </h1>
          <p style="color:#fff">Veuillez telecharger le formulaire d'inscription en cliquant  <a  target='_blank' href ='https://vote.misscameroun.org/images/formulaire2024.pdf'>ici  </a></p>
           <!--<p style="color:#fff">Les frais d'inscriptions s'élèvent à 10.000 fcfa. Les finales regionales en mars.Bien vouloir consulter le calendrier des finales regionales <a class="font-weight-bold" style ="color:red" href = "https://vote.misscameroun.org/images/calendrier.jpeg">ici</a></p>-->
