...
<body>
    ...
    @include('front.partials.header1')
      ...
      <div class="container-fluid" data-aos="fade-up">
        <div class="gallery-slider swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"><a href="{{asset('images/partenaires/camtel2.png')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('images/partenaires/camtel2.png')}}" class="img-fluid" alt=""></a></div>
            <!--<div class="swiper-slide"><a href="{{asset('images/partenaires/imhome.jpeg')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('images/partenaires/imhome.jpg')}}" class="img-fluid" alt=""></a></div>
            ...
            <div class="swiper-slide"><a href="{{asset('images/partenaires/art2.jpeg')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('images/partenaires/art2.jpeg')}}" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a href="{{asset('images/partenaires/art3.jpeg')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('images/partenaires/art3.jpeg')}}" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a href="{{asset('images/partenaires/art4.jpeg')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('images/partenaires/art4.jpeg')}}" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a href="{{asset('images/partenaires/art5.jpeg')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('images/partenaires/art5.jpeg')}}" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a href="{{asset('images/partenaires/art6.jpeg')}}" class="gallery-lightbox" data-gall="gallery-carousel"><img src="{{asset('images/partenaires/art6.jpeg')}}" class="img-fluid" alt=""></a></div>
